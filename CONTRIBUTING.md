...
Discussion of this work occurs on the [Agent Communication Protocols
Working Group mailing list](mailto:agent2agent@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/agent2agent),
[subscribe](https://www.ietf.org/mailman/listinfo/agent2agent)).
...
[Working Group documents](https://datatracker.ietf.org/wg/agentproto/documents/).
